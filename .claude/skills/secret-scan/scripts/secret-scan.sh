...
ENCRYPTED_GLOB=""      # e.g. 'secrets/*.yaml', or "" if none
ENCRYPTED_MARKERS=""   # e.g. 'ENC\[' (grep -E, ANDed with a 2nd check below if needed), or ""
...
GITIGNORE_PATTERNS=("*.db" "*.sqlite" "*.sqlite3")
