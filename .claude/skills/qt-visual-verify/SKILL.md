...
5. **Run the script** with `QT_QPA_PLATFORM=offscreen nix develop --command python <script>.py` (PySide6 only exists in the dev shell; `QT_QPA_PLATFORM=offscreen` renders with no display).
